...
const ChattingMain = () => {
    ...
    const isHistoryDetail = searchParams.get("history") === "true";

    return (
        <div className="chatting-main">
            <Element variant={isHistoryDetail ? "simple" : (activeTab === "History" ? "chat-list" : "alarm")} />

            {isHistoryDetail && (
                <button onClick={() => navigate(-1)} style={{
                    position: 'absolute', top: '110px', left: '16px', zIndex: 999,
                    background: '#e8daf7', border: 'none', borderRadius: '50%',
            ...
            <div className={`chat-ui ${activeTab === "History" ? "history-mode" : ""} ${isHistoryDetail ? "history-detail-mode" : ""}`}>
                {activeTab === "Chat" && !isHistoryDetail && <h1 className="page-title">Chat AI</h1>}
                ...
                {/* Main Content Area */}
                <div className="chat-content-area" ref={scrollRef} style={isHistoryDetail ? { paddingBottom: '90px' } : {}}>
                    {activeTab === "Chat" ? (
                        messages.length === 0 ? (
            ...
            {activeTab === "Chat" && (
                <div className="input-section" style={isHistoryDetail ? { bottom: 0, paddingBottom: 20 } : {}}>
                    {!isHistoryDetail && <div className="input-label">What would you like to know?</div>}
